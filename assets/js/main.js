...
const sendEmail = (e) =>{
    ...
    if(contactName.value === '' || contactEmail.value === '' || contactProject.value === ''){
        ...
        emailjs.sendForm('service_9750gbg','template_0nui0t8','#contact-form','5l4TbScOoums3IK9z')
            .then(() =>{
...
sr.reveal(`.home__data, .projects__container, .achievements__container, .footer__container`)
